 ...
 * 5) Add factory to {@link com.skycat.mystical.common.spell.SpellGenerator#consequenceFactories}<br>
 * 6) Add config options to {@link com.skycat.mystical.common.ConfigModel}<br>
 ...
 * 4) Add factory to {@link com.skycat.mystical.common.spell.SpellGenerator#consequenceFactories}<br>
 * 5) Add config options to {@link com.skycat.mystical.common.ConfigModel}<br>
 * 6) Make sure that {@link com.skycat.mystical.common.spell.SpellHandler} {@code implements MyEvent}. If it does not:<br>
 * - Add handling logic (see {@link com.skycat.mystical.common.spell.SpellHandler#afterBlockBreak} for example).<br>
